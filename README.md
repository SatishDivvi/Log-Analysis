...
2. where to get the newsdata.sql file with the database schema and data.
   - Click the [link](https://d17h27t6h515a5.cloudfront.net/topher/2016/August/57b5f748_newsdata/newsdata.zip) to download the **newsdata.sql** file or you can download the file from my repository.
   - Extract **newsdata.sql** file to the /vagrant folder of your VM.
